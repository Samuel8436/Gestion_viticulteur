...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 11 mars 2024 à 05:50
...
--
-- Déchargement des données de la table `cliants`
--
...
--
-- Déchargement des données de la table `factur`
--
...
--
-- Déchargement des données de la table `peseur`
--
...
--
-- Déchargement des données de la table `raisin`
--
...
--
-- Index pour la table `raisin`
--
ALTER TABLE `raisin`
  ADD PRIMARY KEY (`id_raisin`);
...
--
-- AUTO_INCREMENT pour la table `cliants`
--
ALTER TABLE `cliants`
...
--
-- AUTO_INCREMENT pour la table `factur`
--
ALTER TABLE `factur`
...
--
-- AUTO_INCREMENT pour la table `peseur`
--
ALTER TABLE `peseur`
...
--
-- AUTO_INCREMENT pour la table `raisin`
--
ALTER TABLE `raisin`
  MODIFY `id_raisin` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `transporteur`
  MODIFY `id_transp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
