...
//
                                ...
                                mysqli_query($conn, "update tb_products set name='$name',description='$description',category='$category',originated='$originated',price='$price',quantity='$quantity',location='$location' where productID='$get_id'") or die(mysqli_query());
